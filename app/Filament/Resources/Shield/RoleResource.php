...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    /**
     * Mapping of role keys to human friendly labels.
     * Add or adjust entries here to control how roles are displayed in the UI.
     *
    ...
    {
        return static::$roleLabels[$key] ?? \Str::headline($key);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ...
                    ->formatStateUsing(fn($state): string => static::getRoleLabel($state))
                    ->colors(['primary'])
                    ->searchable(),
