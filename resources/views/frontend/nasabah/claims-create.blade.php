...
<div class="container mx-auto px-6 py-12">
    <div class="max-w-3xl mx-auto bg-white rounded-2xl p-6 shadow">
        ...
        <p class="text-sm text-slate-600 mb-6">Pastikan polis aktif dan dokumen pendukung sudah siap.</p>
            ...
            <div id="claimStep2" class="hidden grid gap-4">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-slate-500" id="claimLimit">Maksimal sesuai coverage polis terpilih.</p>
...
<script>
    ...
    const preselectedPolicyId = @json($selectedPolicyId);
    ...
    if (preselectedPolicyId) {
        policySelect.value = preselectedPolicyId;
        updateSummary();
        updateStepState(2);
    } else {
        updateSummary();
